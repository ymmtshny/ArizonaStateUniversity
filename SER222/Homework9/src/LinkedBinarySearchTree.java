                                        ...
                                        implements BinarySearchTreeADT<T>
{
    ...
    public T findMin() throws EmptyCollectionException 
    {
        // TODO: May need to implement.
        if(root == null) {
            throw new EmptyCollectionException("findMin");
        }
        BinaryTreeNode<T> tempMin = root;
         while (tempMin.getLeft() != null) {
             tempMin = tempMin.getLeft();
         }

        return  tempMin.getElement();
    }
    ...
    public T findMax() throws EmptyCollectionException 
    {
        // TODO: May need to implement.
        if(root == null) {
            throw new EmptyCollectionException("findMax");
        }
        BinaryTreeNode<T> tempMax = root;
        while (tempMax.getRight() != null) {
            tempMax = tempMax.getRight();
        }

        return  tempMax.getElement();
    }
    ...
    { 
        // TODO: May need to implement.
        return (LinkedBinarySearchTree<T>) super.getLeft();
    }
    ...
    {
        // TODO: May need to implement.
        return (LinkedBinarySearchTree<T>) super.getRight();
    }
